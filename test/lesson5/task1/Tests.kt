...
class Tests {
    ...
    fun buildGrades() {
        ...
        assertEquals(
            mapOf(5 to listOf("Михаил", "Семён"), 3 to listOf("Марат")),
            buildGrades(mapOf("Семён" to 5, "Марат" to 3, "Михаил" to 5))
                .mapValues { (_, v) -> v.sorted() }
        )
    }
    ...
    fun containsIn() {
        ...
        assertFalse(containsIn(mapOf("a" to "zee", "b" to "sweat"), mapOf("a" to "zee", "b" to "sweet")))
        assertFalse(containsIn(mapOf("a" to "zee", "b" to "sweet", "c" to "sour"), mapOf("a" to "zee", "b" to "sweet")))
    }
